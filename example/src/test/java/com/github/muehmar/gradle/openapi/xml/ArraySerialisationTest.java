...
public class ArraySerialisationTest {
  ...
  @Test
  void serialize_when_containerArrayDto_then_matchXml() throws JsonProcessingException {
    final String xml = XML_MAPPER.writeValueAsString(CONTAINER_ARRAY_DTO);
    assertEquals(CONTAINER_ARRAY_XML, xml);
  }

  @Test
  void deserialize_when_containerArrayDto_then_matchDto() throws JsonProcessingException {
  ...
  @Test
  void serialize_when_containerWrappedArrayDto_then_matchXml() throws JsonProcessingException {
    final String xml = XML_MAPPER.writeValueAsString(CONTAINER_WRAPPED_ARRAY_DTO);
    assertEquals(CONTAINER_WRAPPED_ARRAY_XML, xml);
  }

  @Test
  void deserialize_when_containerWrappedArrayDto_then_matchDto() throws JsonProcessingException {
  ...
  @Test
  void serialize_when_containerStandardArrayDto_then_matchXml() throws JsonProcessingException {
  ...
  @Test
  void deserialize_when_containerStandardArrayDto_then_matchDto() throws JsonProcessingException {
