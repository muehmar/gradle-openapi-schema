...
import static com.github.muehmar.gradle.openapi.generator.java.generator.pojo.getter.TristateJsonGetter.tristateJsonGetterGenerator;
...
class TristateJsonGetterTest {
  ...
  void generate_when_generatorSettings_then_matchSnapshot(
    ...
    final Generator<JavaPojoMember, PojoSettings> generator =
        tristateJsonGetterGenerator(generatorSettings);
  ...
  public static Stream<Arguments> generatorSettings() {
    return Stream.<PList<GetterGeneratorSetting>>of(PList.empty())
  ...
  void generate_when_noJson_then_noOutput() {
    final Generator<JavaPojoMember, PojoSettings> generator =
        tristateJsonGetterGenerator(GetterGeneratorSettings.empty());
