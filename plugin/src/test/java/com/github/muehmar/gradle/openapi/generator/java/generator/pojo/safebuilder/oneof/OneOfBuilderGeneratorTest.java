...
class OneOfBuilderGeneratorTest {
  ...
  void generate_when_oneOfPojo_then_correctOutput(SafeBuilderVariant variant) {
    final Generator<JavaObjectPojo, PojoSettings> generator = oneOfBuilderGenerator(variant);
