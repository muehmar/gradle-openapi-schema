...
import static com.github.muehmar.gradle.openapi.generator.java.generator.pojo.mapmapping.MapMapMethod.mapMapMethod;
...
@SnapshotTest
class MapMapMethodTest {
  private Expect expect;

  @Test
  void mapMapMethod_when_called_then_correctOutput() {
    final Generator<Void, Void> generator = mapMapMethod();
