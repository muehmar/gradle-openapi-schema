...
class SchemaMapperChainTest {
  ...
  void mapSchema_when_dateSchema_then_localDateReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new DateSchema(), null, CHAIN);
  ...
  void mapSchema_when_dateTimeSchema_then_localDateTimeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new DateTimeSchema(), null, CHAIN);
  ...
  void mapSchema_when_booleanSchema_then_booleanTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new BooleanSchema(), null, CHAIN);
  ...
  void mapSchema_when_integerSchema_then_integerTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new IntegerSchema(), null, CHAIN);
  ...
  void mapSchema_when_numberSchema_then_floatTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new NumberSchema(), null, CHAIN);
  ...
  void mapSchema_when_uuidSchema_then_uuidTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new UUIDSchema(), null, CHAIN);
  ...
  void mapSchema_when_passwordSchema_then_stringTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new PasswordSchema(), null, CHAIN);
  ...
  void mapSchema_when_binarySchema_then_byteArrayTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new BinarySchema(), null, CHAIN);
  ...
  void mapSchema_when_fileSchema_then_stringTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new FileSchema(), null, CHAIN);
    assertEquals(JavaTypes.STRING, mappedSchema.getType());
    assertEquals(PList.empty(), mappedSchema.getOpenApiPojos());
  }
  ...
  void mapSchema_when_emailSchema_then_stringTypeReturned() {
    final MappedSchema<JavaType> mappedSchema =
        CHAIN.mapSchema(
            Name.of("pojoName"), Name.of("pojoMemberName"), new EmailSchema(), null, CHAIN);
