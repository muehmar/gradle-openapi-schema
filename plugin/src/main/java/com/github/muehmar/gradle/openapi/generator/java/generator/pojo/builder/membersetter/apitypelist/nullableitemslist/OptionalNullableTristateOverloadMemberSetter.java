...
import static com.github.muehmar.gradle.openapi.generator.java.generator.pojo.builder.membersetter.apitypelist.Writers.tristateListArgumentConversionWriter;
...
public class OptionalNullableTristateOverloadMemberSetter implements MemberSetter {
  ...
  public String memberValue() {
    return String.format(
        ...
        tristateListArgumentConversionWriter(member, javaArrayType).asString(),
  ...
  public PList<String> getRefs() {
    return tristateListArgumentConversionWriter(member, javaArrayType)
        .getRefs()
