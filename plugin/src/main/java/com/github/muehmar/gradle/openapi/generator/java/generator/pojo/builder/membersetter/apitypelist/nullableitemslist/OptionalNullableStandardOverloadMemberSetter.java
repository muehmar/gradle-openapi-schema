...
@Value
public class OptionalNullableStandardOverloadMemberSetter implements MemberSetter {
  ...
  public static Optional<MemberSetter> fromMember(JavaPojoMember member) {
    return member
        ...
        .map(
            javaArrayType ->
                new OptionalNullableStandardOverloadMemberSetter(member, javaArrayType));
  }
