...
class SerialisationTest {
  ...
  @Test
  void writeValueAsString_when_adminDtoOfInlinedDto_then_correctJson() throws Exception {
    final AdminDto adminDto =
        AdminDto.builder()
            .setId("admin-id")
            .setAdminname("admin-name")
  ...
  @Test
  void writeValueAsString_when_userDtoOfInlinedDto_then_correctJson() throws Exception {
    final UserDto userDto =
        UserDto.builder()
            .setId("user-id")
            .setUsername("user-name")
  ...
  @Test
  void writeValueAsString_when_adminAndUserDto_then_correctJson() throws Exception {
    final UserDto userDto =
        UserDto.builder()
            .setId("id")
            .setUsername("user-name")
