...
@SnapshotTest
class AdditionalPropertyClassGeneratorTest {
  private Expect expect;

  @Test
  @SnapshotName("additionalPropertyClassGenerator")
  void additionalPropertyClassGenerator_when_used_then_matchSnapshot() {
    final Generator<Void, Void> generator = additionalPropertyClassGenerator();
